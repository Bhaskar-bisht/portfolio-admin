...
import { Edit, SelectInput, SimpleForm, useGetList } from "react-admin";
...
export const ContactList = () => {
    ...
    const { data, total, isLoading } = useGetList("contacts", {
    ...
    return (
        <div style={{ padding: "28px 32px", width: "100%", boxSizing: "border-box" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
                <h1 style={{ fontSize: "1.4rem", fontWeight: 700, color: "#111827", margin: 0 }}>Contacts</h1>
...
// Contact Edit — read-only fields + status update only
    ...
    return (
        <div style={{ width: "100%", padding: 32, boxSizing: "border-box" }}>
            <div style={{ marginBottom: 24, paddingBottom: 16, borderBottom: "1px solid #F3F4F6" }}>
                <h2 style={{ fontSize: "0.95rem", fontWeight: 600, color: "#111827", margin: 0 }}>Contact Message</h2>
                <p style={{ fontSize: "0.78rem", color: "#9CA3AF", margin: "4px 0 0" }}>
                    View message details and update status
                </p>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 24 }}>
                ...
                >
                    ...
                    <InfoRow label="Email" value={undefined} />
                    <InfoRow label="Subject" value={undefined} />
                </div>
                <div
                    style={{
                        background: "#F9FAFB",
                ...
                >
                    ...
                    <p style={{ fontSize: "0.875rem", color: "#374151", margin: 0, lineHeight: 1.6 }}></p>
                </div>
            </div>

            {/* Editable status */}
            <div style={{ borderTop: "1px solid #F3F4F6", paddingTop: 20 }}>
                <p style={{ fontSize: "0.78rem", fontWeight: 600, color: "#374151", marginBottom: 12 }}>
                    Update Status
                </p>
                <SelectInput
                    source="status"
