    ...
    const columns = useMemo(
        () => [
            ...
            columnHelper.accessor("startingPrice", {
                ...
                cell: (info) =>
                    info.getValue() != null ? (
                        <span style={{ fontWeight: 600, color: "#059669" }}>${info.getValue()}</span>
                    ) : (
    ...
    return (
        <div style={{ padding: "28px 32px", width: "100%", boxSizing: "border-box" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
                <h1 style={{ fontSize: "1.4rem", fontWeight: 700, color: "#111827", margin: 0 }}>Services</h1>
...
const ServiceFormFields = ({ isCreate = false }) => (
    <div style={{ width: "100%", padding: 32, boxSizing: "border-box" }}>
        <div style={{ marginBottom: 24, paddingBottom: 16, borderBottom: "1px solid #F3F4F6" }}>
            ...
            <p style={{ fontSize: "0.78rem", color: "#9CA3AF", margin: "4px 0 0" }}>Fill in service details below</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 20, width: "100%" }}>
            ...
            {!isCreate && <NumberInput source="startingPrice" label="Starting Price ($)" min={0} />}
        </div>
        ...
        >
            <BooleanInput source="isActive" label="Active" {...(isCreate ? { defaultValue: true } : {})} />
        </div>
    </div>
);
